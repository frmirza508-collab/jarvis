...
export const APP_VERSION: string = typeof __JARVIS_VERSION__ !== 'undefined' ? __JARVIS_VERSION__ : '0.1.0-dev';
...
export const LICENSE_API_URL: string =
  (IS_RELEASE ? (typeof __LICENSE_API_URL__ !== 'undefined' ? __LICENSE_API_URL__ : undefined) : process.env.JARVIS_LICENSE_API_URL) ?? 'http://127.0.0.1:8787';

/** Development license bypass is impossible in release builds. */
export const DEVELOPMENT_LICENSE_MODE: boolean = !IS_RELEASE && process.env.JARVIS_LICENSE_MODE === 'development';
